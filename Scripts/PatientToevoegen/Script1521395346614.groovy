...
WebUI.setText(findTestObject('Page_EPD online/input_patientfirst_name'), 'klaas')

WebUI.setText(findTestObject('Page_EPD online/input_patientlast_name'), 'baas')
...
WebUI.setText(findTestObject('Page_EPD online/input_patientinsurance_company'), 'detester')

WebUI.setText(findTestObject('Page_EPD online/input_patientinsurance_number'), '123456')
